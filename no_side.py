...
class ImageClassifierApp:
    ...
    def create_widgets(self):
        ...
        tk.Button(top_frame, text="打开文件夹", 
        ...
        tk.Button(btn_frame, text="← 上一张", 
                width=10, command=self.prev_image).pack(side=tk.LEFT, padx=40)
        
        self.similar_btn = tk.Button(btn_frame, text="相似", 
                                   bg="#aaffaa", width=10, height=2,
                                   state=tk.DISABLED, command=lambda: self.move_image(True))
        self.similar_btn.pack(side=tk.LEFT, padx=10)
        
        self.dissimilar_btn = tk.Button(btn_frame, text="不相似", 
                                     bg="#ffaaaa", width=10, height=2,
                                     state=tk.DISABLED, command=lambda: self.move_image(False))
        self.dissimilar_btn.pack(side=tk.LEFT, padx=10)
        
        tk.Button(btn_frame, text="下一张 →", 
                width=10, command=self.next_image).pack(side=tk.RIGHT, padx=40)
